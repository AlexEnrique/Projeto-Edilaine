 ...
 */
public class JanelaAlterarDeficiencias extends javax.swing.JFrame {
    ...
    public JanelaAlterarDeficiencias() throws FileNotFoundException {
    ...
    private void initComponents() throws FileNotFoundException {
        ...
        jPanel3.setBorder(BorderFactory.createLineBorder(new Color(255, 255, 255), 1));
        ...
        jComboBoxAud1.addActionListener(new ActionListener() {
          ...
          public void actionPerformed(ActionEvent evt) {
            ...
            try {
                ...
                Logger.getLogger(JanelaAlterarDeficiencias.class.getName()).log(Level.SEVERE, null, ex);
            }
          }
        });
        ...
        if (json.getString("deficiencia?").equals("sim")) {
          jRadioButtonSim.setSelected(true);
          // jScrollPane.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(255, 255, 255), 1));
        ...
        jButtonNext.setText("Confirmar e voltar");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaAlterarDeficiencias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
