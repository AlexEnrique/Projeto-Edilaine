 ...
 */
public class AvisoCompilando extends javax.swing.JFrame {
    int x, y;

    public AvisoCompilando() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText(" Dentro de alguns segundos, o pdf do seu currículo será gerado");
        jLabel4.setText("na área de trabalho.");
        jLabel5.setText(" Nota: Caso seja a primeira vez rodando o programa, o tempo ne-");
        jLabel6.setText("cessário será muito maior, pois é necessário baixar alguns arquivos.");
        ...
        jButtonOk.addActionListener(new java.awt.event.ActionListener() {
          ...
          public void actionPerformed(java.awt.event.ActionEvent evt) {
              try {
                  ...
                  Logger.getLogger(AvisoCompilando.class.getName()).log(Level.SEVERE, null, ex);
              }
          }
        });
        ...
        jLabelIcon.setIcon(new javax.swing.ImageIcon("warning.png"));
