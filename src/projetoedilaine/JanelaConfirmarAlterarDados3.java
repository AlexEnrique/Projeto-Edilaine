 ...
 */
public class JanelaConfirmarAlterarDados3 extends javax.swing.JFrame {
    ...
    public JanelaConfirmarAlterarDados3() throws FileNotFoundException {
    ...
    private void initComponents() throws FileNotFoundException {
        ...
        jLabel3.setText("Confirme seus dados referentes à seção \"Formação Acadêmica\"");
          ...
          jTextFieldJL4.get(k).getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void ChangeJSON() {
              ...
              try {
                ...
                Logger.getLogger(JanelaConfirmarAlterarDados3.class.getName()).log(Level.SEVERE, null, ex);
              }
            }
          });
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaConfirmarAlterarDados3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
