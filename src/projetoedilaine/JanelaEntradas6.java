...
public class JanelaEntradas6 extends javax.swing.JFrame {
    ...
    public JanelaEntradas6() throws FileNotFoundException {
    ...
    private void initComponents() throws FileNotFoundException {
        ...
        jLabel3.setText("Está janela corresponde à seção \"Formação Acadêmica\" do currículo. A mesma é opcional");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaEntradas6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
