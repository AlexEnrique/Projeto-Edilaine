 ...
 */
public class JanelaConfirmarAlterarDados6 extends javax.swing.JFrame {
    ...
    public JanelaConfirmarAlterarDados6() throws FileNotFoundException {
    ...
    private void initComponents() throws FileNotFoundException {
        ...
        jLabel3.setText("Confirme os dados das seções extras do seu currículo");
        ...
        jButtonNext.addActionListener(new java.awt.event.ActionListener() {
          ...
          public void actionPerformed(java.awt.event.ActionEvent evt) {
              try {
                  ...
                  Logger.getLogger(JanelaConfirmarAlterarDados6.class.getName()).log(Level.SEVERE, null, ex);
              }
          }
        });
    ...
    private void jButtonNextActionPerformed(java.awt.event.ActionEvent evt) throws IOException {
        WriteJSON();
        new JanelaSalvarDados(this).setVisible(true);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaConfirmarAlterarDados6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
