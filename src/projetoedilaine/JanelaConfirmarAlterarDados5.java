 ...
 */
public class JanelaConfirmarAlterarDados5 extends javax.swing.JFrame {
    ...
    public JanelaConfirmarAlterarDados5() throws FileNotFoundException {
    ...
    private void initComponents() throws FileNotFoundException {
        ...
        jLabel3.setText("Confirme os dados da seção \"Habilidades Profissionais\"");
          ...
          jTextFieldJL6.get(k).getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void ChangeJSON() {
              ...
              try {
                ...
                Logger.getLogger(JanelaConfirmarAlterarDados5.class.getName()).log(Level.SEVERE, null, ex);
              }
            }
          });
    ...
    private void jButtonNextActionPerformed(java.awt.event.ActionEvent evt) throws IOException {
        WriteJSON();
        // new WriteTemplate3();
        new JanelaConfirmarAlterarDados6().setVisible(true);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaConfirmarAlterarDados5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
