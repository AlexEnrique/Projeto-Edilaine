 ...
 */
public class JanelajButtonObsVirtuais extends javax.swing.JFrame {
    private int x, y;
    ...
    public JanelajButtonObsVirtuais() throws FileNotFoundException {
    ...
    private void initComponents() {
        ...
        jLabelTextoPrincipal.setText("Digite abaixo as observações sobre seus endereços virtuais");
        ...
        jTextArea.setText(json.getString("obsVirtuais"));
      ...
      private void jButtonMinimizeMouseExited(java.awt.event.MouseEvent evt) {
       ...
       private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) throws FileNotFoundException {
         json.put("obsVirtuais", jTextArea.getText());
         try {
           WriteJSON();
         } catch (IOException ex) {
           Logger.getLogger(JanelajButtonObsVirtuais.class.getName()).log(Level.SEVERE, null, ex);
