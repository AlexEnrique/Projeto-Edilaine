...
public class JanelaTemplates extends javax.swing.JFrame {
    ...
    public JanelaTemplates() throws FileNotFoundException {
    ...
    private void initComponents() throws FileNotFoundException {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(900 - 30 - 100, 900 - 30 - 100, 900 - 30 - 100)
                .addComponent(jButtonPrevious, 100, 100, 100))
        );
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Logger.getLogger(JanelaTemplates.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
